...
const contentFieldMap = {
  hero: [
    ...
    { key: "bodyBold", label: "Body Bold", type: "toggle" },
    { key: "bodyGlow", label: "Body Glow", type: "toggle" },
    { key: "chipBold", label: "Hero Chips Bold", type: "toggle" },
    { key: "chipGlow", label: "Hero Chips Glow", type: "toggle" },
    ...
    { key: "secondaryButtonSolid", label: "Secondary Button Solid", type: "toggle" },
    { key: "clientProjectButtonText", label: "Real Client Project Button Text" },
    { key: "clientProjectButtonLink", label: "Real Client Project Button Link" },
    { key: "clientProjectButtonSolid", label: "Client Project Button Solid", type: "toggle" },
  ...
  contact: [
    ...
    { key: "formSubject", label: "Form Subject" },
      ...
      { key: "formPhoneLabel", label: "Form Phone Label" },
      { key: "formPhonePlaceholder", label: "Form Phone Placeholder" },
      { key: "formMessageLabel", label: "Form Message Label" },
      { key: "formMessagePlaceholder", label: "Form Message Placeholder", type: "textarea" },
      { key: "formButtonText", label: "WhatsApp Button Text" },
    ],
  footer: [
    { key: "visible", label: "Visible", type: "toggle" },
    { key: "navLabel", label: "Nav Label" },
